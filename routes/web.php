...
Route::get('/divisi', [DivisiController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('divisi.index');
...
//user pengguna
Route::get('/user', [UserController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('user.index');
Route::post('/user/create', [UserController::class, 'store'])->middleware('ceksesi', 'cekstatus:ADMIN')->name('user.store');
Route::get('/user/show/{id}', [UserController::class, 'show'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('user.show');
...
//kategori
Route::get('/kategori', [KategoriController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('kategori.index');
...
//brand
Route::get('/brand', [BrandController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('brand.index');
...
//lokasi
Route::get('/lokasi', [RuangController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('ruang.index');
...
//jenis_pemeliharaan
Route::get('/jenis_pemeliharaan', [JenisPemeliharaanController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('jenis_pemeliharaan.index');
...
//vendor
Route::get('/vendors', [\App\Http\Controllers\VendorController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('vendor.index');
...
//aset
Route::get('/aset', [AsetController::class, 'index'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.index');
Route::post('/aset/create', [AsetController::class, 'store'])->middleware('ceksesi', 'cekstatus:ADMIN')->name('aset.store');
Route::get('/aset/show/{id}', [AsetController::class, 'show'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.show');
...
Route::get('/aset/qrcode', [AsetController::class, 'qrcode'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.qrcode');
Route::get('/aset/scan_qrcode', [AsetController::class, 'scan_qrcode'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.scan_qrcode');
Route::get('/aset/cetakqrcode', [AsetController::class, 'cetakqrcode'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.cetakqrcode');


//export & import data aset
Route::get('/export-data-aset', [AsetController::class, 'aset_export'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.export');
Route::post('/import-data-aset', [AsetController::class, 'aset_import'])->middleware('ceksesi', 'cekstatus:ADMIN,DIREKSI')->name('aset.import');
...
Route::get('/download-sample', function () {
    $file = public_path() . "/DataContoh/data-contoh.xlsx";
