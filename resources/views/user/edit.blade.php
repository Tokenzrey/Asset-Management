                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xl-12 mt-3">
                                ...
                                <select class="form-control" name="divisi" id="divisi" required>
                                    ...
                                    <option value="{{ $divisi->id }}" {{ $div==$divisi->id ? 'selected' : '' }}>
                                        {{ $divisi->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-xl-12 mt-3">
                                ...
                                <div class="radio">
                                    <label for="status_a" class="form-check-label">
                                        <input type="radio" {{ $status=='ADMIN' ? 'checked' : '' }} required
                                            id="status_a" name="status" value="ADMIN" class="form-check-input"> ADMIN
                                    </label>

                                    <label for="status_d" class="form-check-label">
                                        <input type="radio" {{ $status=='DIREKSI' ? 'checked' : '' }} required
                                            id="status_d" name="status" value="DIREKSI" class="form-check-input">
                                        DIREKSI
                                    </label>

                                    <label for="status_u" class="form-check-label">
                                        <input type="radio" {{ $status=='USER' ? 'checked' : '' }} required
                                            id="status_u" name="status" value="USER" class="form-check-input"> USER
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 mt-3">
                                ...
                                <div>
                                    @if ($user->gambar)
                                    <img class="img-thumbnail" src="{{ asset('storage/' . $user->gambar) }}" alt=""
                                        width="100px">
