        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="text-center">
                    ...
                    <div>
                        @if ($user->gambar != null)
                        <img class="avatar-lg  img-thumbnail" src="{{ asset('storage/' . $user['gambar']) }}" alt=""
                            width="100px" />
                        @else
                        <img class="avatar-lg  img-thumbnail" src="{{ asset('simas/images/ava.png') }}" alt=""
                            width="100px" />
                        @endif
                    </div>
                    <h5 class="mt-3 mb-1">
                        ...
                        <div class="tab-content">
                            <div id="about-me" class="tab-pane fade active show">
                                <div class="profile-personal-info">
                                    <br>
                                    @if ($user->no_telepon == null || $user->jenis_kelamin == null || $user->alamat ==
                                    null)
                                                        ...
                                                        <div>
                                                            <label for="jk_p" class="form-check-label ml-5 ">
                                                                <input type="radio" {{ $jk=='Perempuan' ? 'checked' : ''
                                                                    }} checked required id="jk_p" name="jk"
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <div>
                                                        ...
                                                        <img class="img-thumbnail"
                                                            src="{{ asset('storage/' . $user->gambar) }}" alt=""
                                                            width="100px">
                                                        @endif
                                                    </div>
