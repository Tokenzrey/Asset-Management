...
@section('menunya')
<h2>
    Master <i class="fa fa-solid fa-arrow-right"></i> Data Brand
</h2>
@endsection
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h3 class="modal-title"><b>Tambah Brand</b></h3>
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('brand.store') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label><b>Nama Brand</b></label>
                                                    <input type="text" class="form-control" id="store_name"
                                                        placeholder="Masukkan Nama Brand" name="name" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <img src="{{ asset('simas/images/inventory.png') }}"
                                                        alt="" width="70px">
                                                    <h3 class="modal-title"><b>Edit Brand</b></h3>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('brand.update', $item->id) }}" method="POST"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="col-xl-12">
                                                                    <label for="iduser"><b>Nama Brand</b></label>
                                                                    <input type="text" class="form-control"
                                                                        id="name" value="{{ $item->name }}"
                                                                        placeholder="Masukkan Nama Brand" name="name"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
