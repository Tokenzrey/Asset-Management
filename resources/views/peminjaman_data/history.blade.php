                                ...
                                <form action="{{ route('peminjaman.data-history') }}" method="get">
                                    <div class="input-group mb-3">
                                        <select class="form-select text-center" name="filter" aria-label="Filter">
                                            <option value="semua_history_aset" {{ $filter=='semua_history_aset'
                                                ? 'selected' : '' }}>
                                                Semua</option>
                                            <option value="aset_sering_dipinjam" {{ $filter=='aset_sering_dipinjam'
                                                ? 'selected' : '' }}>
                                                Aset Sering Dipinjam</option>
                                            <option value="user_sering_pinjam" {{ $filter=='user_sering_pinjam'
                                                ? 'selected' : '' }}>
                            ...
                            <table class="table table-striped mb-2" id="example3" class="display">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            @if ($asetItem->gambar)
                                            <img class="img-thumbnail" src="{{ asset('storage/' . $asetItem->gambar) }}"
                                                alt="" width="60px">
                                            @endif
                                        </td>
                            ...
                            <table class="table table-striped" id="example3" class="display">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            @if ($userItem->gambar)
                                            <img class="img-thumbnail" src="{{ asset('storage/' . $userItem->gambar) }}"
                                                alt="" width="60px">
                                            @endif
                                        </td>
